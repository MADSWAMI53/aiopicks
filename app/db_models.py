...
class Profile(Base):
    ...
    simkl_client_id: Mapped[str | None] = mapped_column(String(200), nullable=True)
    simkl_access_token: Mapped[str | None] = mapped_column(String(200), nullable=True)
    simkl_history_limit: Mapped[int] = mapped_column(Integer, default=0)
